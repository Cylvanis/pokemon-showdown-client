	...
	this.MainMenuRoom = this.Room.extend({
		...
		initialize: function () {
			...
			if (app.down) {
				...
				buf += '<p><div style="text-align:center"><img width="96" height="96" src="//delta.phunkmaster.com/sprites/gen5/teddiursa.png" alt="" class="pixelated" /></div> Bear with us as we freak out.</p>';
