...
linkStyle('https://delta.phunkmaster.com/style/font-awesome.css?');
linkStyle('https://delta.phunkmaster.com/style/battle.css?a7');
linkStyle('https://delta.phunkmaster.com/style/replay.css?a7');
linkStyle('https://delta.phunkmaster.com/style/utilichart.css?a7');

requireScript('https://delta.phunkmaster.com/js/lib/ps-polyfill.js');
requireScript('https://delta.phunkmaster.com/config/config.js?a7');
requireScript('https://delta.phunkmaster.com/js/lib/jquery-1.11.0.min.js');
requireScript('https://delta.phunkmaster.com/js/lib/html-sanitizer-minified.js');
requireScript('https://delta.phunkmaster.com/js/battle-sound.js');
requireScript('https://delta.phunkmaster.com/js/battledata.js?a7');
requireScript('https://delta.phunkmaster.com/data/pokedex-mini.js?a7');
requireScript('https://delta.phunkmaster.com/data/pokedex-mini-bw.js?a7');
requireScript('https://delta.phunkmaster.com/data/graphics.js?a7');
requireScript('https://delta.phunkmaster.com/data/pokedex.js?a7');
requireScript('https://delta.phunkmaster.com/data/moves.js?a7');
requireScript('https://delta.phunkmaster.com/data/abilities.js?a7');
requireScript('https://delta.phunkmaster.com/data/items.js?a7');
requireScript('https://delta.phunkmaster.com/data/teambuilder-tables.js?a7');
requireScript('https://delta.phunkmaster.com/js/battle-tooltips.js?a7');
requireScript('https://delta.phunkmaster.com/js/battle.js?a7');
